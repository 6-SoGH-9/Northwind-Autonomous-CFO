...
3. Read any currently active Builder Brief(s) in `governance/builder_briefs/`.
...
For a new Architect session: this document, the current Handbook, and the currently active Brief(s). Nothing else by default.
